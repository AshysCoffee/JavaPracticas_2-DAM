		...
		do {
			...
			try {
				...
				case 1:
					...
					String pago = ControlErrores.leerPago(sc.next());
					...
					if (resp.equalsIgnoreCase("Y")) {
						System.out.println("=== COMPRA FINALIZADA === Total : " + totalCompra + " € ");
		...
		do {
			...
			try {
				...
				case 1:
					...
					consultas.posicionJuguete(idJugueteNuevo);
					...
					boolean registrado = cambios.ingresarCambio(motivo, ventaOriginal.getId_stand(),
							ventaOriginal.getId_zona(), ventaOriginal.getId_juguete(), idStandNuevo, idZonaNuevo,
							idJugueteNuevo, ventaOriginal.getId_empleado());
